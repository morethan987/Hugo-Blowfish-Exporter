...
export class HugoBlowfishExporterSettingTab extends PluginSettingTab {
	...
	display(): void {
		...
		new Setting(containerEl)
			...
			.addToggle((toggle) =>
				toggle
					...
					.onChange(async (value) => {
						this.plugin.settings.directExportAfterTranslation =
							value;
						await this.plugin.saveSettings();
					}),
			)
		...
		new Setting(containerEl)
			.setName("中文版面默认导出文件名")
			.setDesc(
				"设置中文版面默认的导出文件名，支持使用 {{title}} 作为文件名占位符",
			)
			.addText((text) =>
				text
		...
		new Setting(containerEl)
			.setName("英文版面默认导出文件名")
			.setDesc(
				"设置英文版面默认的导出文件名，支持使用 {{title}} 作为文件名占位符",
			)
			.addText((text) =>
				text
		...
		new Setting(containerEl)
			...
			.setDesc(
				"设置中文默认的展示性链接语言版本，其实就是您的网站下不同语言文章的文件名",
			)
			.addText((text) =>
				text
		...
		new Setting(containerEl)
			...
			.setDesc(
				"设置英文默认的展示性链接语言版本，其实就是您的网站下不同语言文章的文件名",
			)
			.addText((text) =>
				text
