...
function getBlockquote(type: string): string {
    switch (type.toLocaleLowerCase()) {
      case 'note':
        ...
        case 'info':
            return `<blockquote class="callout is-info">`;
        case 'todo':
            return `<blockquote class="callout is-todo">`;
        case 'tip':
        case 'hint':
        case 'important':
            return `<blockquote class="callout is-tip">`;
        case 'success':
        case 'check':
        case 'done':
            return `<blockquote class="callout is-success">`;
        case 'warning':
        case 'caution':
        case 'attention':
            return `<blockquote class="callout is-warning">`;
        case 'question':
        case 'help':
        case 'faq':
            return `<blockquote class="callout is-question">`;
        case 'danger':
        case 'error':
            return `<blockquote class="callout is-danger">`;
        case 'example':
            return `<blockquote class="callout is-example">`;
        default:
            return `<blockquote class="callout is-note">`;
    }
}
